...
export const metadata: Metadata = { title: "Forgot Password — Front Office Servicing NC II" };
      ...
      <div className="w-full max-w-[440px]">
        <div className="rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mb-6 text-center">
            <h1 className="text-[24px] leading-tight font-bold text-[#172033]">Forgot your password?</h1>
            <p className="mt-1 text-sm text-[#64748B]">Enter your email and we&apos;ll send you a reset link.</p>
          </div>
